function [u,info] = ElasticityVEM3(node3,elem3,pde,bdStruct)
%PoissonVEM3 solves Poisson equation in 3-D
%
%       u = [u1, u2, u3]
%       -div sigma(u) = f in \Omega,
%       Consistitutive model: 
%       sigma(u) = C epsilon(u)
%       where C is a fourth order tensor, epsilon(u) = 0.5 * (Grad u + Grad u.T)
%       Dirichlet boundary condition u = [g1_D, g2_D, g3_D] on \Gamma_D,
%       Neumann boundary condition  sigma(u)n = [g1_N, g2_N, g3_N] on \Gamma_N
%
%   References
%   Da Veiga, L. Beirao, C. Lovadina, and D. Mora. "A virtual element method
%   for elastic and inelastic problems on polytope meshes." 
%   Computer methods in applied mechanics and engineering 295 (2015): 327-346.
%
%
% Copyright (C)  Isaac Ju.
